...
<?php include ("include/menu.php"); ?>
    ...
    <?php
        ...
        $jemaat = mysqli_query ($konek, "SELECT a.id_jemaat, a.nama_jemaat, a.jenis_kelamin, a.golongan_darah, a.pendidikan_terakhir, a.alamat, a.id_licom, b.nama_licom FROM tbl_jemaat a JOIN tbl_licom b ON a.id_licom=b.id_licom WHERE a.id_licom='$id_licom' ORDER by a.id_jemaat DESC");
            if($jemaat == false){
